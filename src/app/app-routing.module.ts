...
const routes: Routes = [
  ...
  { path: 'pasajero', loadChildren: () => import('./pages/pasajero/pasajero.module').then(m => m.PasajeroPageModule) }, // Corregido: PasajeroPageModule
  { path: 'conductor', loadChildren: () => import('./pages/conductor/conductor.module').then(m => m.ConductorPageModule) }, // Asegúrate de que exista ConductorPageModule
